...
Public Class WinInet
    ...
    ' WinInet constants.
    Private Const INTERNET_ACCESS_TYPE_DIRECT As Integer = 1

    ' Member constants.
    Private Const USER_AGENT As String = "IE"
    ...
    Sub New()
        ...
        _handle = WinInet.InternetOpen(USER_AGENT, _
    ...
    Public Function GetHttpFile(ByVal url As String) As Byte()
        ...
        ' Open http request.
        session = WinInet.InternetOpenUrl(Me._handle, url, _
        ...
        Else
            ...
            Do ' Read bytes from http stream until all are read.
                ...
                response = WinInet.InternetReadFile(session, newBuffer, _
    ...
    Public Sub Dispose() Implements System.IDisposable.Dispose
        ...
        WinInet.InternetCloseHandle(_handle.ToInt32)
        Me._disposed = True
    End Sub
