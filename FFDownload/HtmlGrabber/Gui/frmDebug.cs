...
namespace HtmlGrabber
{
    ...
    public class Debug : Form
    {
        ...
        private DataGrid _grdRSS;

        internal virtual DataGrid grdRSS
        {
        ...
        private Timer _tmrDownload;

        internal virtual Timer tmrDownload
        {
            [MethodImpl(MethodImplOptions.Synchronized)]
            get
            {
        ...
        private void InitializeComponent()
        {
            ...
            _tmrDownload = new Timer(components);
