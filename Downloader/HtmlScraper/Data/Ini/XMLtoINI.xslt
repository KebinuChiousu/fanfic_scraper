...
<xslt:template match="item">
   <xslt:apply-templates select="@key" /><xslt:text>=</xslt:text><xslt:apply-templates select="@value" /><xslt:text>
</xslt:text>
</xslt:template>
...
<xslt:template match="comment">
   <xslt:text>;</xslt:text><xslt:value-of select="text()"/><xslt:text>
</xslt:text>
</xslt:template>
